...
const Blog = () => {
    return (
        <div className='grid md:grid-cols-1  lg:grid-cols-3 pt-6 ' >
            <div className="max-w-md p-6 overflow-hidden rounded-lg shadow dark:bg-gray-900 dark:text-gray-100 mb-3 ">
                <article>
            ...
            <div className="max-w-md p-6 mb-3 overflow-hidden rounded-lg shadow dark:bg-gray-900 dark:text-gray-100">
                <article>
            ...
            <div className="max-w-md p-6 mb-3 overflow-hidden rounded-lg shadow dark:bg-gray-900 dark:text-gray-100">
                <article>
                    ...
                    <p className="mt-4 dark:text-gray-400">PrivateRoute component is the blueprint for all private routes in the application. If the user is logged in, go on and display the component in question; otherwise, redirect the user to sign-in page. Additionally, we can define the logic of isLogin utility function separately in utils folder.</p>
